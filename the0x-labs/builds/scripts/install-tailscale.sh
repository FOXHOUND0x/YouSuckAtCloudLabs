...
# Script is taken directly from curl -fsSL https://tailscale.com/install.sh | sh. 
# We don't want to run scripts from the internet without knowing what they do, so we're copying the script here.
